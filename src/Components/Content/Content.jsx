...
import { FaDribbble, FaWhatsapp, FaInstagram } from "react-icons/fa";
  ...
  return (
    <div className={`content ${DarkTheme && "dark"}`}>
      <div className="row header">
        <AiFillSetting className="cog" />
        <div className="txt-head">Current Notifications</div>
      ...
      <div className="row tall-square">
        ...
        <span className="tools-section sm-screen">More Tools</span>

        <div className="tools sm-screen">
        ...
        <div className="divider sm-screen"></div>
      ...
      <div className="row tall-square inv-bg">
        ...
        <div className="admin">
          ...
          <div className="info">
            ...
            <span className="admin-about">Front-End & Content Creator</span>
          </div>
        ...
        <section>
          ...
          <div className="more-details">
            ...
            <span className="txt">
              ...
              Repudiandae quidem accusamus corrupti quas iure fuga magnam dicta,
